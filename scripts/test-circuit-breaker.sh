...
MAX_RETRIES=5
RETRY_DELAY=2
OPEN_STATE_WAIT_SECONDS="${OPEN_STATE_WAIT_SECONDS:-60}"
RECOVERY_READY_CHECKS="${RECOVERY_READY_CHECKS:-15}"
RECOVERY_TRAFFIC_ATTEMPTS="${RECOVERY_TRAFFIC_ATTEMPTS:-10}"
