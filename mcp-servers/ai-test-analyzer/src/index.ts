 ...
 * K6 부하 테스트 결과 분석
 */
async function analyzeK6Test(args: any) {
 ...
 */
async function analyzeCircuitBreakerTest(args: any) {
 ...
 * Health Check 결과 분석
 */
async function analyzeHealthCheck(args: any) {
  const { testId, rawData } = args;
 ...
 * 모니터링 통계 분석
 */
async function analyzeMonitoringStats(args: any) {
 ...
 * K6 분석 프롬프트 생성
 */
function buildK6AnalysisPrompt(scenario: string, rawData: any): string {
 ...
 */
function buildCircuitBreakerAnalysisPrompt(rawData: any): string {
 ...
 */
function buildHealthCheckAnalysisPrompt(rawData: any): string {
 ...
 * 모니터링 통계 분석 프롬프트 생성
 */
function buildMonitoringStatsAnalysisPrompt(testType: string, rawData: any): string {
 ...
 * AI 분석 결과 파싱
 */
function parseAnalysisResult(analysisText: string, rawData: any) {
  // 메트릭 추출 시도
